...
@Component({
  selector: 'App-hh',
  templateUrl: './CompanyStudentReportFinnal.component.html',
  styleUrls: ['./CompanyStudentReportFinnal.component.css'],
  providers: [CompanyService, BottomToastsManager, InternFollowService]
})
export class CompanyStudentReportFinnalComponent extends CommonComponent<CompanyEntity> {
