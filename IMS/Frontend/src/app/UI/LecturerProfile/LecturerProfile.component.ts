...
export class LecturerProfileComponent extends CommonComponent<LecturerEntity> {
  ...
  constructor(public LecturerService: InternReportService, toastr: BottomToastsManager, vcr: ViewContainerRef, public route: ActivatedRoute, UserService: UserService) {
