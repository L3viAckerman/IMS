...
@Component ({
  ...
  templateUrl: './LectureListStudent.component.html',
  styleUrls: ['./LectureListStudent.component.css'],
  providers: [CompanyService, BottomToastsManager,LecturerService,UserService]
})
export class LectureListStudentComponent extends CommonComponent<LecturerEntity> {
  User: UserEntity;
