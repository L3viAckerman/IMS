...
namespace IMS.Modules.MCompany
{
    ...
    public class CompanyController : CommonController
    {
        ...
        {
            return CompanyService.Count(UserEntity, SearchCompanyEntity);
        }
        [Route(""), HttpGet]
        public List<CompanyEntity> Get(SearchCompanyEntity SearchCompanyEntity)
        {
            return CompanyService.Get(UserEntity, SearchCompanyEntity);
        }
        [Route("{Id}"), HttpGet]
        public CompanyEntity Get(Guid Id)
        {
            return CompanyService.Get(UserEntity, Id);
        }
        [Route(""), HttpPost]
        ...
        {
            return CompanyService.Update(UserEntity, Id, CompanyEntity);
        }
        [Route("{Id}"), HttpDelete]
        public bool Delete(Guid Id)
        {
            return CompanyService.Delete(UserEntity, Id);
        }
    }
}
