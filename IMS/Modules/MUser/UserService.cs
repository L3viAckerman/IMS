...
namespace IMS.Modules.MUser
{
    public class UserService : CommonService, IUserService
    {
        ...
        public string Login(UserEntity UserEntity)
        {
            ...
            UserEntity.Roles = ROLES.USER;
            if (User.Admin != null) UserEntity.Roles = UserEntity.Roles | ROLES.ADMIN;
            if (User.Student != null) UserEntity.Roles = UserEntity.Roles | ROLES.STUDENT;
            if (User.Lecturer != null) UserEntity.Roles = UserEntity.Roles | ROLES.LECTURER;
            if (User.HrEmployee != null) UserEntity.Roles = UserEntity.Roles | ROLES.HrEmployee;
