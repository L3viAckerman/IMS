...
namespace IMS.Modules.MInternFollow
{
    public class InternFollowEntity
    {
        ...
        public InternFollowEntity(InternFollow InternFollow, params object[] args)
        {
            ...
            {
                if (arg is Student)
                    this.StudentEntity = InternFollow.Student == null ? null : new StudentEntity(arg as Student);
                if (arg is InternNews)
                    this.InternNewsEntity = InternFollow.InternNews == null ? null : new InternNewsEntity(arg as InternNews);
            }
