...
namespace IMS.Modules.MInternshipCourse
{
    ...
    public class InternshipCourseController : CommonController
    {
        ...
        //Use by both HR and Student and Lecture
        [Route("InternStudent/{StudentId}"), HttpGet]
        public InternshipCourseEntity GetByStudentId([FromRoute] Guid StudentId)
        {
            return internshipCourseService.GetByStudentId(UserEntity, StudentId);
        }
        [Route("Count"), HttpGet]
        public long Count(SearchInternshipCourseEntity SearchInternshipCourseEntity)
        {
            return internshipCourseService.Count(UserEntity, SearchInternshipCourseEntity);
        }
        [Route(""), HttpPost]
