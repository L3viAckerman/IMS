...
namespace IMS.Modules.MInternReport
{
    ...
    {
        long Count(UserEntity userEntity, SearchInternReportEntity SearchInternReportEntity);
        ...
        InternReportEntity Update(UserEntity userEntity, Guid Id, InternReportEntity InternReportEntity);
